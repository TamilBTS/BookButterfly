...
<body style="background-color: #f7f2fa;">
	...
	<div class="container-fluid back-img">
		<h5 class="text-center">Recent Books</h5>
		...
		<%
					...
					<div class="card mb-4 crd-ho">
						...
						<div class="card-body ">
							...
							</a> <a href="view_books.jsp?bid=<%=b.getBookId() %>" class="btn btn-outline btn1 btn1-ho btn-block text-center"> <i
					...
					<div class="card mb-4 crd-ho">
						...
						<div class="card-body ">
							...
							%><a href="view_books.jsp?bid=<%=b.getBookId() %>" class="btn btn-outline btn1 btn1-ho btn-block text-center"> <i
								class="fa-solid fa-book pr-2"></i>View
							</a>
							</div>
						<div class="card-footer">
